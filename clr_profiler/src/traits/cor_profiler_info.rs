use crate::{
    ffi::{
        ...
        ObjectID, ThreadID, Unknown, COR_DEBUG_IL_TO_NATIVE_MAP, COR_IL_MAP, COR_PRF_MONITOR,
        DWORD, HANDLE, HRESULT, LPCBYTE,
    },
...
pub trait CorProfilerInfo {
    ...
    ) -> Result<&mut Unknown, HRESULT>; // TODO: Ok result needs to implement IMetaDataImport

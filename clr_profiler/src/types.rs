use crate::ffi::{
    ...
    CorProfilerMethodEnum, FunctionID, ModuleID, ProcessID, ReJITID, Unknown, BYTE,
...
pub struct FunctionTokenAndMetadata {
    pub metadata_import: *mut Unknown, // TODO: struct field needs to implement IMetaDataImport
    pub token: mdMethodDef,
}
#[derive(Debug)]
